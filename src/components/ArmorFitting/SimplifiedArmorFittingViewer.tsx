...
export interface SimplifiedArmorFittingViewerRef {
  // Mesh access
  getMeshes: () => {
    avatar: THREE.SkinnedMesh | null
    armor: THREE.Mesh | null
...
interface SimplifiedArmorFittingViewerProps {
  avatarUrl?: string
  armorUrl?: string
  helmetUrl?: string
  showWireframe: boolean
...
export const SimplifiedArmorFittingViewer = forwardRef<
  SimplifiedArmorFittingViewerRef,
  SimplifiedArmorFittingViewerProps
>((props, ref) => {
  ...
  // Services
  const genericFittingService = useRef(new GenericMeshFittingService())
